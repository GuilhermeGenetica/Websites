/**
 * pages/ResendVerification.jsx — Resend email verification link
 */
    ...
    return (
        <div className="login-root">
            <div className="login-card">
                ...
                <p className="login-subtitle">Resend verification email</p>

                {sent ? (
                    <div>
                        <div className="login-info" role="status">
                            If that email is registered and not yet verified, a new verification link
                    ...
                    <>
                        <p style={{ fontSize: '13px', color: 'var(--text-secondary)', marginBottom: '0.75rem', lineHeight: 1.5 }}>
